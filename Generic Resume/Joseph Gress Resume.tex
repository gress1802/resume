...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {\textbf{IT Architecture Intern}}{April 2024 -- Present}
      {Johnson Controls}{Milwaukee, WI}
      \resumeItemListStart
        \resumeItem{Playing a key role as an inventor of a \textbf{sales copilot (RAG)}, primarily utilizing \textbf{Azure OpenAI (GPT4)}, \textbf{Azure AI Search}, and \textbf{Azure ML Prompt Flow} to save approximately 15\% of time spent searching documents}
    ...
    \resumeSubheading
      ...
      {Johnson Controls}{Milwaukee, WI}
      \resumeItemListStart
      \resumeItem{Utilized \textbf{spaCy}, \textbf{pandas}, and \textbf{gensim} in a VOC analysis of over 10,000 user comments, helping to identify key areas of improvement and aid allocation of 1/2 of total commercial funding for fy24}
